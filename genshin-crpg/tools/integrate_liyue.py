...
LIYUE_RECRUIT_COST={
 'LIYUE_XIANGLING':(480,{'ING_RICE':3,'ING_SHRIMP':2}),'LIYUE_XINGQIU':(520,{'MAT_TREASURE_INSIGNIA':3}),'LIYUE_CHONGYUN':(300,{'MAT_DAMAGED_MASK':4,'ORE_IRON':4}),'LIYUE_YAOYAO':(320,{'ING_RICE':3}),
 'LIYUE_GAMING':(520,{'ORE_IRON':5,'MAT_TREASURE_INSIGNIA':2}),'LIYUE_XINYAN':(380,{'ORE_IRON':6}),'LIYUE_YANFEI':(600,{'MAT_TREASURE_INSIGNIA':4}),'LIYUE_YUNJIN':(550,{'ORE_CRYSTAL':3}),
 'LIYUE_LANYAN':(320,{'ORE_IRON':8}),'LIYUE_XIAO':(320,{'ORE_CRYSTAL':4}),'LIYUE_BEIDOU':(380,{'ORE_CRYSTAL':6,'TRPG_SCRAP_METAL':2}),'LIYUE_HUTAO':(550,{'ORE_IRON':4,'MAT_DAMAGED_MASK':2}),
 'LIYUE_KEQING':(520,{'ORE_IRON':8,'MAT_TREASURE_INSIGNIA':3}),'LIYUE_QIQI':(500,{'MAT_DAMAGED_MASK':3,'ING_RICE':2}),'LIYUE_YELAN':(650,{'MAT_SILVER_INSIGNIA':2,'MAT_TREASURE_INSIGNIA':3}),'LIYUE_GANYU':(600,{'ORE_CRYSTAL':4,'MAT_STAINED_MASK':1}),
 'LIYUE_TARTAGLIA':(700,{'MAT_CHAOS_DEVICE':2,'MAT_SILVER_INSIGNIA':2}),'LIYUE_NINGGUANG':(800,{'ORE_CRYSTAL':5,'MAT_CHAOS_DEVICE':2}),'LIYUE_BAIZHU':(700,{'ORE_CRYSTAL':3,'MAT_STAINED_MASK':2}),
 'LIYUE_SHENHE':(650,{'ORE_CRYSTAL':5,'MAT_STAINED_MASK':2}),'LIYUE_XIANYUN':(650,{'MAT_CHAOS_CIRCUIT':1,'ORE_CRYSTAL':5}),'LIYUE_ZIBAI':(750,{'TRPG_SCRAP_METAL':3,'MAT_CHAOS_DEVICE':2})
}
...
for d in legends.values():
 ...
 if char!='LIYUE_ZHONGLI':
  ...
  if char=='LIYUE_ZIBAI':d['START_CONDITION']+=' && FLAG_WORLD_ZIBAI_RETURNED=TRUE'
  d['START_CONDITION']+=' && CURRENT_MAP_ID='+d['MAP_ID']
  if char in LIYUE_RECRUIT_COST:
   d['COST_MORA'],items=LIYUE_RECRUIT_COST[char];d['COST_ITEMS_JSON']=json.dumps(items,separators=(',',':'))
