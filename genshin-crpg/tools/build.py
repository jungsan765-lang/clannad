...
# v0.13.39 retains original story IDs and migrates only pending scene metadata.
rework_base=json.loads((ROOT/'content/story-revisions/rev03-base-save-compatibility.json').read_text())
public['compatibleSaveVersions']=list(dict.fromkeys(public['compatibleSaveVersions']+[rework_base['saveCompatibilityVersion'],rework_base['contentVersion']]+rework_base['compatibleSaveVersions']))
