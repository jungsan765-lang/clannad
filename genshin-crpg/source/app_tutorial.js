...
const tutorialSteps=[
 ...
 {title:'함께 싸울 동료를 정하세요',target:'[data-screen="PARTY"]',text:'정식으로 합류한 동료만 편성합니다. 편성에서 빠지면 그 동료의 장비는 소지품으로 돌아오며, 빼기 전에 한 번 알려 드립니다. 2번 자리는 개인 임무를 마친 동료의 전투 호감도가 오릅니다.'},
